...
public class EmployeeProfileController {
    ...
    public EmployeeProfileResponseDto createEmployeeProfile(
            @RequestPart(name = "profile") EmployeeProfileDto employeeProfileDto,
            @RequestPart(name = "photo", required = false) MultipartFile photo
    ) {
        return employeeProfileService.createEmployeeProfile(employeeProfileDto, photo);
    }
    ...
    public EmployeeProfileResponseDto updateEmployeeProfile(
        ...
        return employeeProfileService.updateEmployeeProfile(id, employeeProfileDto, photo);
    }
